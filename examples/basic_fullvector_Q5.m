...
% Vector for ridge half-width from 3.305 to 3.44 in 10 steps
vecRidgeHalfWidth = linspace(3.305, 3.44, 10);
vecNeff = zeros(1, length(vecRidgeHalfWidth));

% Loop to changes the ridge half-width from 3.305 to 3.44 in 10 steps
